Shader "圣剑战姬 Shader/水波纹_Additive_Off"  {
Properties {
	_TintColor ("主色调", Color) = (0.5,0.5,0.5,0.5)
	_NoiseTex ("波动贴图", 2D) = "white" {}
	_MainTex ("主贴图", 2D) = "white" {}
	_HeatTime  ("波动频率", range (-1,1)) = 0.1
	_ForceX  ("水平强度", range (0,1)) = 0.1
	_ForceY  ("垂直强度", range (0,1)) = 0.1
}
...
fixed4 frag( v2f i ) : COLOR
{
	...
	return 2.0f *  tex2D( _MainTex, i.uvmain);
}
ENDCG
		}
}
